"""Configuration for V1 Demo - Interactive single-sample steering."""
...
class Config:
    """Immutable configuration for v1 demo."""
    ...
    # Temporal structure (v1: 32 timesteps = 1.5s)
    n_timesteps: int = 32
    attack_end: int = 8
    body_end: int = 24
...
def get_project_root() -> Path:
    ...
    # demo/v1/config.py -> v1 -> demo -> project_root
